...
BEGIN
  ...
  -- Super-admin invitation flow: auto-assign trainer role, no application needed
  ...
  -- Trainer-invited client flow: auto-assign client role + link to trainer
  IF _invited_as = 'client' THEN
