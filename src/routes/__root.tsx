...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ValhallaFit" },
      { name: "description", content: "Fit Coach Connect is a web app for personal trainers to manage clients, create workouts, and track progress." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "ValhallaFit" },
      { property: "og:description", content: "Fit Coach Connect is a web app for personal trainers to manage clients, create workouts, and track progress." },
