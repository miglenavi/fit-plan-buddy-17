...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Manage clients, build progressive workout plans, and track performance from one platform." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "ValhallaFit — Coaching platform for personal trainers" },
      { name: "twitter:description", content: "Manage clients, build progressive workout plans, and track performance from one platform." },
